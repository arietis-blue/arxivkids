          ...
          <el-footer class="footer-container">
            ...
            <el-scrollbar height="100%">
              ...
              <div class="demo-collapse mt-2">
                <el-collapse v-for="k_d in detailPaper.Keywords" :key="k_d.Keyword">
